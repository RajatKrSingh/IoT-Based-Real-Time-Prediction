# -*- coding: utf-8 -*-
"""
Created on Thu Jul 13 15:37:54 2017
...
for i in np.arange(0,1000):   
    charge = np.append(charge,20.0*(1-exp(-i/250.0)))
    wave_initial[100+i] = wave_initial[100+i] + charge[i]

for i in np.arange(1100,10000):   
    wave_initial[i] = wave_initial[i] + 20.0
    
plt.plot(wave_initial)
plt.show()
